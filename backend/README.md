...
## Project Structure
    ...
    ├── testapiautoteammemb_94466  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_94466`
...
2. Clone this repo and `cd testapiautoteammemb_94466`
